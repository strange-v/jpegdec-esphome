...
//#define HAS_SIMD
...
#if defined(ESP_PLATFORM) && defined(CONFIG_IDF_TARGET_ESP32S3) && defined(JPEGDEC_HAVE_S3_SIMD)
  #ifndef ESP32S3_SIMD
    #define ESP32S3_SIMD 1
  #endif
  #ifdef __cplusplus
    extern "C" {
  #endif
  void s3_ycbcr_convert_444(uint8_t *pY, uint8_t *pCB, uint8_t *pCR,
                             uint16_t *pOut, int16_t *pConsts, uint8_t ucPixelType);
  ...
  /* Only one definition in this TU; make it file-local to avoid duplicate symbol */
  static int16_t i16_Consts[8] = { 0x80, 113, 90, 22, 46, 1, 32, 2048 };
#endif /* ESP32-S3 SIMD */
