> [!IMPORTANT]
>
> This repository is based entirely on [bitbank2/JPEGDEC](https://github.com/bitbank2/JPEGDEC) — an excellent JPEG decoding library by Larry Bank. I couldn’t use the original repository in the ESPHome [external component](https://github.com/strange-v/RemoteWebViewClient), so I modified it slightly to enable SIMD.
